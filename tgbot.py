...
from button import menyu,oqish,erkaklar,ayollar,gusl,quran1,masjid
...
async def echo_handler(message: Message) -> None:
    await message.answer(text="https://maps.google.com/maps?q=41.376788,60.362592&ll=41.376788,60.362592&z=16", reply_markup=masjid)

@dp.message(F.text=='🕌Xasan Basriy🕌')
async def echo_handler(message: Message) -> None:
    await message.answer(text="https://maps.google.com/maps?q=41.408503,60.331076&ll=41.408503,60.331076&z=16", reply_markup=masjid)
            
@dp.message(F.text=='🕌Kasmabot jomey Masjidi🕌')
async def echo_handler(message: Message) -> None:
    await message.answer(text="https://maps.google.com/maps?q=41.391646,60.332701&ll=41.391646,60.332701&z=16", reply_markup=masjid)


@dp.message(F.text=='Xiva Navoz Vaqtlari⏲️')
async def echo_handler(message: Message) -> None:
    await message.answer(text="https://t.me/masjidXiva/2178", reply_markup=menyu)
