...
async def echo_handler(message: Message) -> None:
    await message.answer_location(latitude=41.376788,longitude=60.362592, reply_markup=masjid)

@dp.message(F.text=='🕌Xasan Basriy🕌')
async def echo_handler(message: Message) -> None:
    await message.answer_location(latitude=41.408503,longitude=60.331076, reply_markup=masjid)
        
@dp.message(F.text=='🕌Kasmabot jomey Masjidi🕌')
async def echo_handler(message: Message) -> None:
    await message.answer_location(latitude=41.391646,longitude=60.332701, reply_markup=masjid)
